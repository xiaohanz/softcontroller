...
public class Activator extends ComponentActivatorAbstractBase {
    ...
    public Object[] getImplementations() {
        Object[] res = { L2ForwardingManager.class };
        return res;
    }
    ...
    public void configureInstance(Component c, Object imp, String containerName) {
        if (imp.equals(L2ForwardingManager.class)) {
            // export the services
            Dictionary<String, String> props = new Hashtable<String, String>();
            props.put("salListenerName", "L2ForwardingManager");
            ...
            c.add(createContainerServiceDependency(containerName).setService(
                    IL2flowmanager.class).setCallbacks("setL2flowmanager",
                    "unsetL2flowmanager").setRequired(false));
        }
    }
}