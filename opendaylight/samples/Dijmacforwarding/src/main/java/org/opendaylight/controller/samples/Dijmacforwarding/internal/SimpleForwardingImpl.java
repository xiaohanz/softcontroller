...
public class SimpleForwardingImpl implements IfNewHostNotify,
    ...
    private static String FORWARDING_RULES_CACHE_NAME = "forwarding.macswitch.rules";
...
//            match.setField(MatchType.DL_TYPE, EtherTypes.IPv4.shortValue());
            ...
            match.setField(MatchType.DL_DST, hostMac);
...
//                actions.add(new SetDlDst(host.getDataLayerAddressBytes()));
            ...
            String policyName = this.macByteToString(hostMac);
            ...
            if (!inPort.getType().equals(NodeConnectorIDType.ALL)) {
                ...
                log.debug("Adding policyMatch(DIP = {}) Action(outPort= {}) " +
                        "to node {}", new Object[] {
                        host.getDataLayerAddress(), outPort,
                        currNode});
            }
        }
    }
