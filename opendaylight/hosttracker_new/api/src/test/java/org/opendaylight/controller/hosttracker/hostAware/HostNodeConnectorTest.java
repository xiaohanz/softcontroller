...
public class HostNodeConnectorTest extends TestCase {
    ...
    public void testHostNodeConnector() throws UnknownHostException {
        ...
        InetAddress hostIP_2 = InetAddress
                .getByName("2001:420:281:1004:e123:e688:d655:a1b0");
        InetAddress hostIP_3 = InetAddress.getByName("192.168.0.28");
        byte[] hostMAC_2 = new byte[] { (byte) 0x11, (byte) 0x22, (byte) 0x33,
                (byte) 0x22, (byte) 0x22, (byte) 0x22 };
        byte[] hostMAC_3 = new byte[] { (byte) 0x11, (byte) 0x22, (byte) 0x33,
        ...
        try {
            hostnodeconnector_2 = new HostNodeConnector(hostMAC_2, hostIP_2,
                    nc1, (short) 2);
            Assert.assertTrue(hostnodeconnector_2.isV6Host());
            Assert.assertTrue(hostnodeconnector_2.getnodeConnector()
                    .equals(nc1));
        ...
        try {
            hostnodeconnector_3 = new HostNodeConnector(new EthernetAddress(
                    hostMAC_3), hostIP_3, nc2, (short) 3);
            byte[] hostMAC_3_rb = hostnodeconnector_3
            ...
            hostnodeconnector_3.initArpSendCountDown().setArpSendCountDown(
                    (short) 10);
