...
//        }
    ...
    public String setStatus(HttpServletRequest request,
        ...
        IFirewall fw = (IFirewall) ServiceHelper.getInstance(
    ...
    @ResponseBody
    public Map<String, Object> getFirewall(HttpServletRequest request, @RequestParam(required = false) String container) {
        String containerName = (container == null) ? GlobalConstants.DEFAULT.toString() : container;
        ...
        ConcurrentMap<String,FirewallRule> firewallMap = fw.getRuleConfigList();
    ...
    public String actionNewFirewall(@RequestParam(required = true) String body,
            @RequestParam(required = false) String nodeId, HttpServletRequest request,
            @RequestParam(required = false) String container) {
        Status result = null;
        String containerName = (container == null) ? GlobalConstants.DEFAULT.toString() : container;
    ...
    @ResponseBody
    public String removeSelectedFirewalls(@RequestParam(required = false) String firewallListIds, HttpServletRequest request,
            @RequestParam(required = false) String container) {
        Status result = null;
        boolean status = true;
        String containerName = (container == null) ? GlobalConstants.DEFAULT.toString() : container;
    ...
    @ResponseBody
    public String toggleFirewalls(@RequestParam(required = true) String firewallListIds,
...
//        boolean status = true;
        ...
        return "Success";//(result.isSuccess()) ? StatusCode.SUCCESS.toString() : result.getDescription();
    }
    ...
    @ResponseBody
    public Map<String, Object> getNodeFirewalls(HttpServletRequest request, @RequestParam(required = false) String container) {
        String containerName = (container == null) ? GlobalConstants.DEFAULT.toString() : container;
